...
import numpy as np
from .graph_utils import add_edge_data, add_vertex_data, add_graph_data
...
class BatchedFixedOrderGraphDataset(FixedOrderGraphDataset):
    def __init__(self, graph_dataset, batch_size):
        super().__init__(
            ...
            flat_graph_state_dim=graph_dataset.flat_graph_state_dim,
            ...
            readout_dim=graph_dataset.readout_dim,
        )
